...
//		
//		return doGeneratToken(claims, userDetails.getUsername());
//		
//	}
//
...
//				.setExpiration(new java.util.Date(System.currentTimeMillis() + JWT_TOKEN_VALIDITY * 100)).signWith(SignatureAlgorithm.HS512, secret).compact();
//	}
//	
